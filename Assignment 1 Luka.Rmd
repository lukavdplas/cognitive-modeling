...
Figure 9: Simulation results of the revised model together with human data.
...
To test this hypothesis, we separated the data from question 5 on whether there were at most 5 breaks. These results are plotted below (Figure 11).
