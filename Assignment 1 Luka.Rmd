...
runAllComplexStrategies <- function(nrSimulations,phoneNumber) {
	...
	ggplot(data = agrResultsMeanDrift, aes(TrialTime/1000, abs(dev))) +
	  geom_point(color="darkgrey") +
	  geom_point(aes(x = steer_focus[1], y = dual_steer_data[1])) +
	  geom_point(aes(x = dial_focus[1], y = dual_dial_data[1])) +
	  xlab("Dial time (s)") +
